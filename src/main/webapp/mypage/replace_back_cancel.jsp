...
<body leftmargin="0" topmargin="0">
  ...
  <!-- ----------------------------------------- -->
          <div style="border:none; width:95%; margin: 0 auto" id="order_menu">
           ...
           <form name="frm" id="frm" method="post" action="./replace_cancel_update.do">
            <input type="hidden" name="payno" id="payno" value="${replace_back.payno }">
            <input type="hidden" name="replace_state" id="replace_state" value="${replace_back.replace_state }">
           <div id="order" style="margin: 2%;">
             <table border="1" style="width: 100%; border-collapse: collapse; text-align: center;">
                ...
                <tr>
                  ...
                  <input type="text" name="replace_reason" id="replace_reason" value="${replace_back.replace_reason }" readonly="readonly" size="50px;">
             </table>
             <br>
             <br>
             <table border="1" style="width: 100%; border-collapse: collapse; text-align: center;">
