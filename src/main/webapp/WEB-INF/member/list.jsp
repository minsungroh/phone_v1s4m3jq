...
<body leftmargin="0" topmargin="0">
  ...
  <TABLE class='table'>
    ...
    <TR>
      ...
      <TD class='td'>
       <A href="./passwd.do?mno=<%=mno%>"><IMG src='./images/password.png' title="암호 변경"></A> 
       <A href="./update.do?mno=<%=mno%>"><IMG src='./images/update.png' title="수정"></A>
       <A href="./delete.do?mno=<%=mno%>"><IMG src='./images/delete.png' title="삭제"></A></TD>
    </TR>
