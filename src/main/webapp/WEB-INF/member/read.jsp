    ...
    <FORM name='frm' method='POST' action='./update.do'>
      ...
      <fieldset>
        <ul>
          ...
          <%=memberVO.getId() %>
          <SPAN id='panel_id'>(ID는 변경 할 수 없습니다)</SPAN>
          </li>
          ...
          <input type='text' name='address2' id='address2' value='<%=memberVO.getAddress2() %>' size='30' placeholder="상세 주소">
          </li>
          
          <li><label class='label'></label> <!-- ----- DAUM 우편번호 API 시작 ----- -->
